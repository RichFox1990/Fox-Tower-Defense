...
MOB_START_POS = -40
# how close in pixels mob has to get before the speed scales to ensure it doesnt overshoot its target (making sure it turns effectively)
APPROACH_RADIUS = 2
...
TOWER_COSTS = {"Stone": [40, 50, 75], "Fire": [
    35, 60, 75], "Sand": [30, 55, 75], "Archer": [35, 60, 80]}
